...
class DownloadOutcome {
  ...
  const DownloadOutcome._(this.kind, {this.sizeBytes = 0, this.errorMessage});
  ...
  static DownloadOutcome otherFailure(String message) => DownloadOutcome._(
    DownloadOutcomeKind.otherFailure,
